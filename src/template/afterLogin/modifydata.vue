<template>
    <div class="main">
        ...
        <Form ref="formValidate" :model="formValidate" :label-width="90">
            ...
            <Form-item label="权限">
                <Select v-model="formValidate.right" placeholder="period">
                    <Option value="2017">0</Option>
                    <Option value="2016">1</Option> 
                    <Option value="2015">3</Option>  
                    <Option value="2014">5</Option>
                    <Option value="2015">7</Option>
                    <Option value="2014">8</Option>
                </Select>
            </Form-item>
            <Form-item>
